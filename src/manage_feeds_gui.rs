...
pub fn do_autocache_gui(target_index: usize, mut podcasts: Vec<Podcast>) -> Vec<Podcast>
{
...
pub fn add_podcast_gui(new_alias: String, new_link: String, download_path: PathBuf, interval: usize, should_lock: bool, mut podcasts: Vec<Podcast>)
{
...
pub fn remove_podcast_gui(target_index: usize, mut podcasts: Vec<Podcast>)
{
...
pub fn edit_podcast_gui(target_index: usize, new_alias_opt: Option<String>, new_link_opt: Option<String>, new_dl_path_opt: Option<PathBuf>, new_interval_opt: Option<usize>, mut podcasts: Vec<Podcast>)
{
...
pub fn update_podcast_gui(target_index: usize, mut podcasts: Vec<Podcast>)
{
    let mut target_podcast = &mut podcasts[target_index];
...
pub fn download_episode_gui(target_index: usize, episode_index: usize, do_normal_episode_order: bool, podcasts: Vec<Podcast>)
{
